...
public class LotteryResponseDecoder extends CumulativeProtocolDecoder {

    private static final String DECODER_STATE_KEY = LotteryResponseDecoder.class.getName() + ".STATE";
