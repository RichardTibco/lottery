...
//        ImageServerIoHandler handler = new ImageServerIoHandler();
    	LotteryServerIoHandler handler = new LotteryServerIoHandler();
...
//        acceptor.getFilterChain().addLast("protocol", new ProtocolCodecFilter(new ImageCodecFactory(false)));
        acceptor.getFilterChain().addLast("protocal", new ProtocolCodecFilter(new LotteryCodecFactory(false)));
